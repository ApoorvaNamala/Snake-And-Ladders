...
EMPTY = '_'
def create_board():
    board1 = [[EMPTY for x in range(board_size)]for x in range(board_size)]
    return board1
...
def snakes_and_ladders():
    ...
    def check_snake_or_ladder(n):
        snakes = {11 : 9, 13 : 11, 17 : 13, 19 : 17, 23 : 19, 29 : 23, 31 : 29, 37 : 31, 41 : 37, 43 : 41, 47 : 43, 53 : 47, 59 : 53, 61 : 59, 67 : 61, 71 : 67, 73 : 71, 79 : 73, 83 : 79, 89 : 83, 97 : 89 }
        ladder = {4 : 6, 9 : 12, 16 : 20, 25 : 30, 36 : 42}
        if n in snakes.keys():
